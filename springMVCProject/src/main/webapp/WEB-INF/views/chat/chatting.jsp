...
<body>
	<div class="container">
		<div class="EnterOut_div">
			...
			<button type="button" class="btn btn-default enter_Btn" id="btnConnect">연결</button>
			<button type="button" class="btn btn-default out_Btn" id="btnDisconnect" disabled>종료</button>
		</div>
		<div id="chat"></div>
	...
	<script>
		...
		$(function() {
			var aa = rand(1, 15);
			$("#chat").css({"background-image" : `url("${path}/resources/image/chat_bg\${aa}.jpg")`});
		});
	</script>
</body>
</html>
